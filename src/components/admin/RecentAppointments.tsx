...
function RecentAppointments() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case "CONFIRMED":
        return (
          <Badge className="bg-blue-100 text-blue-800 border border-blue-200 shadow-sm hover:bg-blue-200 flex items-center gap-1 px-2 py-1">
            <Repeat className="w-3 h-3" /> Confirmed
          </Badge>
        );
      case "COMPLETED":
        return (
          <Badge className="bg-green-100 text-green-800 border border-green-200 shadow-sm hover:bg-green-200 flex items-center gap-1 px-2 py-1">
  ...
  return (
    <Card className="shadow-md border border-border/40">
      ...
      <CardContent className="overflow-x-auto">
        <div className="rounded-lg border border-border/30 shadow-sm">
