    ...
    <section className="relative py-32 px-6 overflow-hidden bg-gradient-to-b from-background via-muted/3 to-background">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-20">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-primary/5 to-primary/10 rounded-full border border-primary/10 backdrop-blur-sm mb-6 animate-[pulse_3s_infinite]">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 tracking-tight">
            ...
            <span className="bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent">
              perfect AI dental plan
            </span>
          </h2>

          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Schedule appointments for free and unlock unlimited AI consultations with premium plans. Perfect for ongoing dental health.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-10 max-w-6xl mx-auto">
          ...
          <div className="relative group">
            <div className="relative bg-gradient-to-br from-card/90 to-card/60 backdrop-blur-xl rounded-3xl p-8 border border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10 hover:scale-[1.02]">
              <div className="space-y-6">
                <div className="space-y-3">
                  ...
                  <p className="text-muted-foreground">
                    Basic appointment scheduling with essential features
                  </p>
                </div>

                <SignUpButton mode="modal">
                  <Button className="w-full py-3 bg-gradient-to-r from-muted to-muted/80 text-foreground rounded-xl font-semibold shadow-sm hover:shadow-md transition-all duration-300">
                    Start Free
                  </Button>
                </SignUpButton>

                <div className="space-y-4">
                  {["Unlimited appointment scheduling", "Locate nearby dentists", "Basic chat support", "Appointment reminders"].map((feature) => (
          ...
          <div className="relative group">
            ...
            <div className="relative bg-gradient-to-br from-card/95 to-card/70 backdrop-blur-xl rounded-3xl p-8 border-2 border-primary/30 hover:border-primary/50 transition-all duration-500 shadow-xl hover:shadow-2xl hover:shadow-primary/20 scale-105">
              <div className="space-y-6">
                <div className="space-y-3">
                  <h3 className="text-2xl font-bold text-primary">AI Basic</h3>
                  <div className="flex items-end gap-1">
                    <span className="text-4xl font-bold bg-gradient-to-r from-primary to-primary/80 bg-clip-text text-transparent">$9</span>
                    <span className="text-muted-foreground mb-1">/month</span>
                  </div>
                  <p className="text-muted-foreground">AI guidance plus appointment booking for smarter dental care</p>
                </div>
                ...
                <div className="space-y-4">
                  {[
                    ...
                    "10 AI voice consultations monthly",
                    "AI dental guidance & tips",
                    "Symptom checking & insights",
                    "Priority customer support",
                    "Call history & AI recordings",
                  ].map((feature) => (
                    <div className="flex items-start gap-3" key={feature}>
                      <CheckCircleIcon className="w-5 h-5 text-primary mt-0.5 shrink-0 " />
                      <span className="text-sm">{feature}</span>
          ...
          <div className="relative group">
            <div className="relative bg-gradient-to-br from-card/90 to-card/60 backdrop-blur-xl rounded-3xl p-8 border border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10 hover:scale-[1.02]">
              <div className="space-y-6">
                <div className="space-y-3">
                  <h3 className="text-2xl font-bold text-primary">AI Pro</h3>
                  <div className="flex items-end gap-1">
                    <span className="text-4xl font-bold">$19</span>
                    <span className="text-muted-foreground mb-1">/month</span>
                  </div>
                  <p className="text-muted-foreground">Unlimited AI consultations and full-featured dental support</p>
                </div>
                ...
                <div className="space-y-4">
                  {[
                    "Everything included in AI Basic",
